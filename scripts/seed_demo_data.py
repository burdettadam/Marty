...
class DemoSeeder:
    ...
    def __init__(self):
        self.postgres_url = os.getenv('POSTGRES_URL', 'postgresql://martyuser:martypassword@postgres-demo:5432/martydb')
    ...
    async def seed_database(self):
        ...
        try:
            ...
            sample_mdls = [
                ('DL123456789', 'California', 'John Doe', '1990-01-15', '2020-01-15', '2025-01-15', 'C'),
                ('DL987654321', 'Texas', 'Jane Smith', '1985-06-22', '2019-06-22', '2024-06-22', 'C'),
                ('DL456789123', 'New York', 'Bob Wilson', '1978-12-03', '2021-12-03', '2026-12-03', 'CDL'),
                ('DL789123456', 'Florida', 'Alice Brown', '1992-09-18', '2022-09-18', '2027-09-18', 'C'),
                ('DL321654987', 'Nevada', 'Charlie Davis', '1987-03-12', '2020-03-12', '2025-03-12', 'M'),
            ]
        ...
        try:
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                for request_data in sample_requests:
                    try:
                        response = await client.post(
                            f"{self.issuer_api_endpoint}/v1/credentials/offer",
                            json=request_data
                        )
