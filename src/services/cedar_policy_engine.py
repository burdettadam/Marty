...
class CedarPolicyEngine:
    ...
    def __init__(self, rule_packs_dir: str = "config/rules"):
        ...
        self.logger.info("Cedar Policy Engine initialized", extra={
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            self.logger.info("Cedar Policy Engine initialized successfully", extra={
    ...
    async def load_rule_pack(self, file_path: str) -> str:
        ...
        try:
            ...
            self.logger.info("Rule pack loaded successfully", extra={
                "pack_id": pack_id,
                "file_path": file_path,
    ...
    def _create_cedar_request(self, context: ValidationContext) -> Dict[str, Any]:
        ...
        return {
            "principal": f"ValidationRule::\"FIELD_EXACT_MATCH\"",  # Would be dynamic
            "action": f"ValidateFieldConsistency",
            "resource": f"ComparisonContext::\"validation_context\""
        }
    ...
    def get_rule_pack_info(self, pack_id: Optional[str] = None) -> Dict[str, Any]:
