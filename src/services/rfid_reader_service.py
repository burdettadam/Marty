...
class RFIDReaderService(rfid_service_pb2_grpc.RFIDServiceServicer):
    ...
    def _initialize_components(self) -> None:
        ...
        try:
            ...
            if self.reader_manager.initialize_readers():
                self.logger.info("RFID readers initialized: %d available", 
    ...
    def ListReaders(self, request: Empty, context: grpc.ServicerContext) -> rfid_service_pb2.ListReadersResponse:
    ...
    def ConnectReader(self, request: rfid_service_pb2.ConnectReaderRequest, 
                     context: grpc.ServicerContext) -> rfid_service_pb2.ConnectReaderResponse:
    ...
    def ReadPassport(self, request: rfid_service_pb2.ReadPassportRequest,
                    context: grpc.ServicerContext) -> rfid_service_pb2.ReadPassportResponse:
    ...
    def VerifyDocument(self, request: rfid_service_pb2.VerifyDocumentRequest,
                      context: grpc.ServicerContext) -> rfid_service_pb2.VerifyDocumentResponse:
    ...
    def ExtractBiometrics(self, request: rfid_service_pb2.ExtractBiometricsRequest,
                         context: grpc.ServicerContext) -> rfid_service_pb2.ExtractBiometricsResponse:
...
async def serve_rfid_service(port: int = 50052) -> None:
    ...
    # Add service
    rfid_service_pb2_grpc.add_RFIDServiceServicer_to_server(
        RFIDReaderService(), server
    )
