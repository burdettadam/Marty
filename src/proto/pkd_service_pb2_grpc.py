...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in pkd_service_pb2_grpc.py depends on'
...
class PKDServiceServicer(object):
    ...
    def ListTrustAnchors(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
class PKDService(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def ListTrustAnchors(request,
            target,
            options=(),
