...
if _version_not_supported:
    raise RuntimeError(
        f"The grpc package installed is at version {GRPC_VERSION},"
         " but the generated code in dtc_engine_pb2_grpc.py depends on"
...
class DTCEngineServicer:
    """Digital Travel Credential (DTC) Engine Service"""

    def CreateDTC(self, request, context) -> NoReturn:
    ...
    def GetDTC(self, request, context) -> NoReturn:
    ...
    def SignDTC(self, request, context) -> NoReturn:
    ...
    def RevokeDTC(self, request, context) -> NoReturn:
        """Revoke a DTC"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        msg = "Method not implemented!"
    ...
    def GenerateDTCQRCode(self, request, context) -> NoReturn:
    ...
    def TransferDTCToDevice(self, request, context) -> NoReturn:
    ...
    def VerifyDTC(self, request, context) -> NoReturn:
        """Verify a DTC"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        msg = "Method not implemented!"
    ...
    def LinkDTCToPassport(self, request, context) -> NoReturn:
...
def add_DTCEngineServicer_to_server(servicer, server) -> None:
    rpc_method_handlers = {
