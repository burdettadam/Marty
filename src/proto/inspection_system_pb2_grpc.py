...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in inspection_system_pb2_grpc.py depends on'
...
class InspectionSystemStub(object):
...
class InspectionSystemServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_InspectionSystemServicer_to_server(servicer, server):
    rpc_method_handlers = {
