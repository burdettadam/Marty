...
if _version_not_supported:
    raise RuntimeError(
        f"The grpc package installed is at version {GRPC_VERSION},"
         " but the generated code in mdl_engine_pb2_grpc.py depends on"
...
class MDLEngineServicer:
    """Missing associated documentation comment in .proto file."""

    def CreateMDL(self, request, context) -> NoReturn:
    ...
    def GetMDL(self, request, context) -> NoReturn:
    ...
    def SignMDL(self, request, context) -> NoReturn:
    ...
    def GenerateMDLQRCode(self, request, context) -> NoReturn:
    ...
    def TransferMDLToDevice(self, request, context) -> NoReturn:
    ...
    def VerifyMDL(self, request, context) -> NoReturn:
...
def add_MDLEngineServicer_to_server(servicer, server) -> None:
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler("mdl.MDLEngine", rpc_method_handlers)
