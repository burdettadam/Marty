...
if _version_not_supported:
    raise RuntimeError(
        f"The grpc package installed is at version {GRPC_VERSION},"
         " but the generated code in mdoc_engine_pb2_grpc.py depends on"
...
class MDocEngineServicer:
    """Missing associated documentation comment in .proto file."""

    def CreateMDoc(self, request, context) -> NoReturn:
    ...
    def GetMDoc(self, request, context) -> NoReturn:
    ...
    def SignMDoc(self, request, context) -> NoReturn:
    ...
    def GenerateMDocQRCode(self, request, context) -> NoReturn:
    ...
    def TransferMDocToDevice(self, request, context) -> NoReturn:
    ...
    def VerifyMDoc(self, request, context) -> NoReturn:
        """Verify an mDoc"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        msg = "Method not implemented!"
    ...
    def CreateDocumentTypeTemplate(self, request, context) -> NoReturn:
    ...
    def GetDocumentTemplates(self, request, context) -> NoReturn:
...
def add_MDocEngineServicer_to_server(servicer, server) -> None:
    rpc_method_handlers = {
