...
class MDocEngine(object):
    ...
    @staticmethod
    def GenerateMDocQRCode(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def TransferMDocToDevice(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def CreateDocumentTypeTemplate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def GetDocumentTemplates(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
