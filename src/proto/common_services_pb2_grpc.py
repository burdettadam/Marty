...
if _version_not_supported:
    raise RuntimeError(
        f"The grpc package installed is at version {GRPC_VERSION},"
         " but the generated code in common_services_pb2_grpc.py depends on"
...
class LoggingStreamerServicer:
    """Service for streaming logs from a service instance"""

    def StreamLogs(self, request, context) -> NoReturn:
...
def add_LoggingStreamerServicer_to_server(servicer, server) -> None:
    rpc_method_handlers = {
