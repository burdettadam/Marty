...
class mDLRequest:
    ...
    def add_document_request(self, 
                           ...
                           name_spaces: Optional[Dict[str, List[str]]] = None,
                           request_info: Optional[Dict[str, Any]] = None) -> None:
    ...
    def from_cbor(cls, data: bytes) -> mDLRequest:
        ...
        return cls(
            version=decoded.get("version", "1.0"),
            doc_requests=decoded.get("docRequests", [])
        )
...
class SessionManager:
    ...
    def __init__(self):
        ...
        self.reader_key: Optional[ec.EllipticCurvePrivateKey] = None
        self.device_key: Optional[ec.EllipticCurvePublicKey] = None
        self.encrypted_counter = 0
        
    def establish_session(self, 
                         device_engagement: DeviceEngagement,
                         reader_key: Optional[ec.EllipticCurvePrivateKey] = None) -> str:
        """
