...
def serve_with_dependencies():
    ...
    try:
        from src.pkd_service.app.core.database import get_database  # type: ignore
        from src.pkd_service.app.services.pkd_service import PKDService  # type: ignore
        from src.proto.pkd_service_pb2_grpc import add_PKDServiceServicer_to_server  # type: ignore
        ...
        factory.serve()
    except Exception:  # pragma: no cover - example code
        pass
