...
class ISO9796Verifier:
    ...
    def verify_signature(self, signature: bytes, message: bytes, 
                        public_key: rsa.RSAPublicKey,
                        scheme: ISO9796Scheme = ISO9796Scheme.SCHEME_1) -> ISO9796SignatureData:
    ...
    def _verify_scheme_1(self, signature: bytes, message: bytes,
                        public_key: rsa.RSAPublicKey) -> ISO9796SignatureData:
    ...
    def _verify_scheme_2(self, signature: bytes, message: bytes,
                        public_key: rsa.RSAPublicKey) -> ISO9796SignatureData:
    ...
    def _rsa_verify_with_recovery(self, signature: bytes, 
                                 public_key: rsa.RSAPublicKey) -> bytes | None:
    ...
    def _parse_scheme_1_structure(self, data: bytes) -> tuple[int, bytes, bytes, HashFunction, bytes] | None:
    ...
    def create_test_signature(self, message: bytes, private_key: rsa.RSAPrivateKey,
                             hash_function: HashFunction = HashFunction.SHA256) -> bytes:
        ...
        try:
            ...
            signature_int = pow(
                structure_int,
                private_numbers.private_exponent,
...
class PassportActiveAuthenticationVerifier:
    ...
    def verify_active_authentication_response(self, challenge: bytes, 
                                            signature: bytes,
    ...
    def analyze_signature_structure(self, signature: bytes,
        ...
        try:
            ...
            recovered_data = self.iso9796_verifier._rsa_verify_with_recovery(
