...
class MRZValidator:
    ...
    def validate_mrz(
        ...
        if validation_level in [MRZValidationLevel.STANDARD, MRZValidationLevel.COMPREHENSIVE, MRZValidationLevel.STRICT]:
    ...
    def _validate_check_digits(self, mrz_data: str, document_class: DocumentClass) -> list[MRZValidationResult]:
        ...
        try:
            if document_class == DocumentClass.PASSPORT:
                ...
                results.append(MRZValidationResult(
                    "Check Digits", True, "Check digit validation not implemented for this document type"
                ))
    ...
    def _validate_td3_check_digits(self, mrz_data: str) -> list[MRZValidationResult]:
        ...
        try:
            ...
            if parsed and parsed.get("check_digits_valid", False):
                ...
                results.append(MRZValidationResult(
                    "TD-3 Check Digits", False, "Check digit validation failed", "CHECK_DIGIT_INVALID"
                ))
        
        except ImportError:
            # Fallback validation
            results.append(MRZValidationResult(
                "TD-3 Check Digits", True, "Check digit validation placeholder (parser not available)"
            ))
    ...
    def _validate_td1_check_digits(self, mrz_data: str) -> list[MRZValidationResult]:
        ...
        try:
            ...
            if parsed and parsed.get("check_digits_valid", False):
                ...
                results.append(MRZValidationResult(
                    "TD-1 Check Digits", False, "Check digit validation failed", "CHECK_DIGIT_INVALID"
                ))
        
        except ImportError:
            # Fallback validation
            results.append(MRZValidationResult(
                "TD-1 Check Digits", True, "Check digit validation placeholder (parser not available)"
            ))
    ...
    def _validate_td2_check_digits(self, mrz_data: str) -> list[MRZValidationResult]:
        ...
        try:
            ...
            if parsed and parsed.get("check_digits_valid", False):
                ...
                results.append(MRZValidationResult(
                    "TD-2 Check Digits", False, "Check digit validation failed", "CHECK_DIGIT_INVALID"
                ))
    ...
    def _manual_td2_check_digit_validation(self, mrz_data: str) -> list[MRZValidationResult]:
        ...
        if len(lines) < 2:
            results.append(MRZValidationResult(
                "TD-2 Check Digits", False, "Insufficient lines for check digit validation", "INSUFFICIENT_DATA"
            ))
            return results
            ...
            if len(line1) >= 10:
                ...
                if expected_check == calculated_check:
                    ...
                    results.append(MRZValidationResult(
                        ...
                        f"Expected {expected_check}, calculated {calculated_check}", "DOC_NUM_CHECK_INVALID"
                    ))
            ...
            if len(line2) >= 7:
                ...
                if expected_check == calculated_check:
                    ...
                    results.append(MRZValidationResult(
                        ...
                        f"Expected {expected_check}, calculated {calculated_check}", "DOB_CHECK_INVALID"
                    ))
        
        except Exception as e:
            results.append(MRZValidationResult(
                "TD-2 Check Digits", False, f"Manual validation error: {e}", "MANUAL_VALIDATION_ERROR"
            ))
