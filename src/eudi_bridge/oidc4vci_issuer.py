...
class OIDC4VCIIssuerFacade:
    ...
    def create_credential_offer(
        ...
        if pre_authorized:
            ...
            grants["authorization_code"] = {"issuer_state": str(uuid.uuid4())}
    ...
    def mint_credential_from_icao_source(
        ...
        credential = VerifiableCredential(
            ...
            issuer={"id": self.issuer_identifier, "name": "Marty EUDI Bridge Issuer"},
    ...
    def mint_credential_from_mdl_source(
        self, mdl_document_data: dict[str, Any], credential_format: str = "mso_mdoc"
    ) -> VerifiableCredential | dict[str, Any]:
        """
    ...
    def _extract_icao_subject_data(
        self, icao_data: dict[str, Any], credential_type: str
    ) -> dict[str, Any]:
    ...
    def _create_sd_jwt_proof(self, credential: VerifiableCredential) -> dict[str, Any]:
        ...
        header = {"alg": "ES256", "typ": "vc+sd-jwt", "kid": self.signing_key.thumbprint()}
    ...
    def _create_mso_mdoc_credential(self, mdl_data: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "doctype": "org.iso.18013.5.1.mDL",
            "issuerSigned": {
                "nameSpaces": {"org.iso.18013.5.1": self._map_mdl_to_iso_namespace(mdl_data)}
            },
            "deviceSigned": {
                "nameSpaces": {},
                "deviceAuth": {
    ...
    def _create_vc_from_mdl(self, mdl_data: dict[str, Any]) -> VerifiableCredential:
        ...
        credential = VerifiableCredential(
            context=["https://www.w3.org/2018/credentials/v1", "https://w3id.org/mobility/v1"],
            id=f"urn:uuid:{uuid.uuid4()}",
            type=["VerifiableCredential", "MobileDrivingLicence"],
            issuer={"id": self.issuer_identifier, "name": "Marty EUDI Bridge Issuer"},
            issuance_date=now.isoformat(),
...
def create_eudi_oidc4vci_issuer(
    ...
    **kwargs,
    ...
    """
    return OIDC4VCIIssuerFacade(issuer_identifier=issuer_id, base_url=base_url, **kwargs)
