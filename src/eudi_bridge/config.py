...
class EUDIBridgeConfig:
    ...
    icao_trust_anchors: list[str] | None = None
    mdl_trust_anchors: list[str] | None = None
...
class EUDIBridgeConfigLoader:
    ...
    def load_config(
        self, environment: str = "development", config_file: str | None = None
    ) -> EUDIBridgeConfig:
        """
...
class EUDIBridgeOrchestrator:
    ...
    def _initialize_services(self):
        ...
        try:
            ...
            if self.config.bridge_service_enabled:
                ...
                self.bridge_service = EUDIBridgeService(self.config.trust_store_path, eudi_config)
            ...
            if self.config.oidc4vci_issuer_enabled:
                ...
                self.oidc4vci_issuer = OIDC4VCIIssuerFacade(
                    issuer_identifier=issuer_identifier, base_url=self.config.base_url
                )
            ...
            if self.config.oid4vp_verifier_enabled:
                ...
                self.oid4vp_verifier = OID4VPPresentationLayer(
                    verifier_identifier=verifier_identifier, base_url=self.config.base_url
                )
    ...
    def translate_and_issue(
        ...
        issuance_options: dict[str, Any] | None = None,
    ) -> dict[str, Any]:
        """
    ...
    def verify_presentation(
        self, presentation_request: dict[str, Any], presentation_data: dict[str, Any]
    ) -> dict[str, Any]:
        """
...
class EUDIBridgeHealthCheck:
    ...
    def _check_dependencies(self) -> dict[str, Any]:
        ...
        return {"all_available": all_healthy, "details": dependencies}
    ...
    def _check_cryptography(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"available": True, "version": cryptography.__version__}
    ...
    def _check_jwt(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"available": True, "version": getattr(jwt, "__version__", "unknown")}
        except ImportError as e:
            return {"available": False, "error": str(e)}
    ...
    def _check_yaml(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"available": True, "version": getattr(yaml, "__version__", "unknown")}
        except ImportError as e:
            return {"available": False, "error": str(e)}
...
def quick_health_check(
    ...
    try:
        ...
        return {"overall_status": "error", "error": str(e), "timestamp": None}
