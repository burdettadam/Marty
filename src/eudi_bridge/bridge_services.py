...
class TranslationResult:
    ...
    success: bool
    target_credential: Optional[Dict[str, Any]]
...
class EUDIBridgeService:
    ...
    def translate_icao_to_eudi(
        ...
        try:
            ...
            compliance_score = self._calculate_eudi_compliance_score(
                icao_data, eudi_credential
            )
            ...
            metadata = CredentialMetadata(
                ...
                verification_status=VerificationStatus.VALID if not errors else VerificationStatus.INVALID,
...
class EUDITrustService:
    ...
    def validate_trust_chain(
        ...
        try:
            trust_anchors = (
                self.icao_trust_anchors if credential_type == "icao"
                else self.mdl_trust_anchors
            )
...
def create_eudi_bridge_service(
    ...
    eudi_config: Optional[Dict[str, Any]] = None
) -> EUDIBridgeService:
    """
