...
class OID4VPPresentationLayer:
    ...
    def __init__(
        ...
        policy_engine: Optional[EUDIPolicyEngine] = None
    ):
        """
    ...
    def create_presentation_request(
        ...
        policy_constraints: Optional[List[PolicyConstraint]] = None
    ) -> PresentationRequest:
        """
    ...
    def create_authorization_url(
        ...
        params = {
            ...
            "presentation_definition": json.dumps(asdict(presentation_request.presentation_definition)),
    ...
    def process_presentation_response(
        ...
        try:
            ...
            return {
                "valid": False,
                "error": str(e),
                "error_code": "invalid_presentation_response"
            }
...
def create_eudi_oid4vp_verifier(
    ...
    **kwargs
    ...
    """
    return OID4VPPresentationLayer(
