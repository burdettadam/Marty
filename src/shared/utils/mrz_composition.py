...
from .mrz_standardized import MRZStandardizedUtils, MRZDocumentType, MRZFieldLength
...
class MRZComposerFactory:
    ...
    def create_composer(cls, document_type: MRZDocumentType) -> BaseMRZComposer:
        ...
        if not composer_class:
            raise ValueError(f"No MRZ composer available for document type: {document_type}")
