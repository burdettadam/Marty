...
from ..models.visa import Visa, VisaType, MRZData, PersonalData, VisaDocumentData
...
class MRZGenerator:
    ...
    def format_name_for_mrz(cls, surname: str, given_names: str, max_length: int) -> str:
        ...
        remaining_length = max_length - len(name_field)
    ...
    def generate_mrz_for_visa(cls, visa: Visa) -> MRZData:
        ...
        if visa.document_data.visa_type == VisaType.MRV_TYPE_A:
            ...
            raise ValueError(f"MRZ generation not supported for visa type: {visa.document_data.visa_type}")
...
class MRZParser:
    ...
    def parse_type_a_mrz(cls, line1: str, line2: str) -> dict:
        ...
        if len(line1) != 44 or len(line2) != 44:
            raise ValueError("Type A MRZ lines must be exactly 44 characters")
    ...
    def parse_type_b_mrz(cls, line1: str, line2: str, line3: str) -> dict:
        ...
        if len(line1) != 36 or len(line2) != 36 or len(line3) != 36:
            raise ValueError("Type B MRZ lines must be exactly 36 characters")
