...
class ServiceConfig:
    ...
    require_immutable_snapshots: bool = os.getenv("REQUIRE_IMMUTABLE_SNAPSHOTS", "false").lower() == "true"
    snapshot_signature_required: bool = os.getenv("SNAPSHOT_SIGNATURE_REQUIRED", "true").lower() == "true"
