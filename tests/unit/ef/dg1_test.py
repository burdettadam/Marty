...
def test_dg1_parsing():
    ...
    assert dg1_data['raw_mrz'] == "I<NLDXI85935F86999999990<<<<<<7208148F1108268NLD<<<<<<<<<<<4VAN<DER<STEEN<<MARIANNE<LOUISE"
...
def test_dg1_data_group():
    ...
    mrz_data = "P<UTOERIKSSON<<ANNA<MARIA<<<<<<<<<<<<<<<<<<<L898902C36UTO7408122F1204159ZE184226B<<<<<10"
    dg1 = DataGroup(
