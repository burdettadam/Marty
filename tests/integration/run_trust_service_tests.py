...
async def run_basic_test():
    ...
    try:
        result = subprocess.run(
            [sys.executable, str(basic_test_path)], capture_output=True, text=True, cwd=project_root
        )
...
async def main():
    ...
    if enhanced_success:
        ...
        print(
            "   The mocked PKD service enables comprehensive testing without external dependencies"
        )
    else:
