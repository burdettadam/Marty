...
def create_suite():
    ...
    suite.addTests(
        unittest.defaultTestLoader.loadTestsFromModule(tests.cert_validator.test_crl_client)
    )
    suite.addTests(
        unittest.defaultTestLoader.loadTestsFromModule(tests.cert_validator.test_ocsp_client)
    )
    suite.addTests(
        unittest.defaultTestLoader.loadTestsFromModule(tests.cert_validator.test_registry)
    )
    suite.addTests(
        unittest.defaultTestLoader.loadTestsFromModule(tests.cert_validator.test_validate)
    )
