            ...
            if self.encryption_enabled and event.details:
                ...
                for field in sensitive_fields:
                    if field in event.details:
                        log_entry['details'][field] = self._encrypt_sensitive_data(str(event.details[field]))
...
async def audit_auth_success(user_id: str, source_ip: str, details: Optional[Dict[str, Any]] = None):
