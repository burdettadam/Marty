...
class TrustServiceSettings(BaseSettings):
    ...
    # ICAO PKD settings
    icao_pkd_url: Optional[str] = Field(default=None, alias="ICAO_PKD_URL")
    icao_pkd_username: Optional[str] = Field(default=None, alias="ICAO_PKD_USERNAME")
    icao_pkd_password: Optional[str] = Field(default=None, alias="ICAO_PKD_PASSWORD")
