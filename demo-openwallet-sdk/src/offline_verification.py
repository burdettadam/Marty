...
class OfflineQREngine:
    ...
    def verify_offline_qr(
        ...
        try:
            ...
            data_check = self._verify_data_requirements(
                offline_package, 
            ...
            all_critical_passed = all(
                check["passed"] for check in verification_result["checks_performed"]
            ...
            verification_result["summary"] = {
                ...
                "passed_checks": sum(1 for c in verification_result["checks_performed"] if c["passed"]),
                "critical_issues": sum(
                    1 for c in verification_result["checks_performed"] 
    ...
    def _prepare_offline_data(self, mdl_data: dict[str, Any]) -> dict[str, Any]:
        ...
        essential_fields = [
            ...
            "age_over_18", "age_over_21", "document_number",
    ...
    def _sign_offline_package(self, package: dict[str, Any]) -> dict[str, Any]:
        ...
        signature_bytes = self.demo_private_key.sign(
            payload_bytes,
    ...
    def _verify_package_integrity(self, package: dict[str, Any]) -> dict[str, Any]:
        ...
        required_fields = [
            "version", "type", "created_at", "expires_at",
            "issuer_id", "mdl_data", "cryptographic_binding", "signature"
        ]
    ...
    def _verify_data_requirements(
        ...
        return {
            ...
            "passed": len(missing_fields) == 0,
            "details": f"Missing required fields: {missing_fields}" if missing_fields else "All requirements met",
            "critical": True,
